...
import com.maxwell.cataclysm_primed_soul.agent.DecayAgent;
...
public final class DecayBootstrap {
    ...
    private static final String AGENT_CLASS = "com.maxwell.cataclysm_primed_soul.agent.DecayAgent";
    private static final String AGENT_RESOURCE = "com/maxwell/cataclysm_primed_soul/agent/DecayAgent.class";
    private static final String BRIDGE_CLASS = "com.maxwell.cataclysm_primed_soul.agent.DecayBytecodeBridge";
    private static final String BRIDGE_RESOURCE = "com/maxwell/cataclysm_primed_soul/agent/DecayBytecodeBridge.class";
    ...
    public static void start() {
        ...
        try {
            ...
            if (instrumentation == null) {
                ...
                Class.forName("com.maxwell.cataclysm_primed_soul.transformer.DecayBytecodeGetterTransformer");
