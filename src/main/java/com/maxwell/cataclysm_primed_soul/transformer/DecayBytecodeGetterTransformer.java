                    ...
                    if ("getClassBytes".equals(mn.name) &&
                        ...
                        for (AbstractInsnNode insnNode : mn.instructions) {
                            if (insnNode instanceof MethodInsnNode methodInsn && methodInsn.name.equals("findFirst")) {
                                ...
                                insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/maxwell/cataclysm_primed_soul/agent/DecayBytecodeBridge", "transformOptionalBytes", "(Ljava/util/Optional;Ljava/lang/String;)Ljava/util/Optional;"));
