...
public abstract class ModLanguageProvider extends LanguageProvider {
    ...
    public static class English extends ModLanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("boss_screen.cataclysm_primed_soul.maledictus_prime.suggestion.3", "Watch the Excalibur stance and punish the recovery window after its impact.");
    ...
    public static class Japanese extends ModLanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("boss_screen.cataclysm_primed_soul.maledictus_prime.suggestion.3", "エクスカリバーの構えを見極め、接地後の後隙を狙って反撃してください。");
