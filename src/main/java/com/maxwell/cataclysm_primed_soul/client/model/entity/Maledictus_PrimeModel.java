...
public class Maledictus_PrimeModel extends HierarchicalModel<Maledictus_PrimeEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = Left_Wing.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(187, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(21.5F, 7.0F, 0.7F, -0.053F, -0.1664F, 0.3099F));

		PartDefinition cube_r6 = Left_Wing.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(187, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.5F, 4.0F, -0.3F, -0.053F, -0.1664F, 0.3099F));

		PartDefinition cube_r7 = Left_Wing.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(187, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.5F, 0.0F, 0.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition cube_r8 = Left_Wing.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(187, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(22.5F, -6.0F, 2.2F, -0.0154F, -0.1739F, 0.0886F));

		PartDefinition Right_Wing = Wings.addOrReplaceChild("Right_Wing", CubeListBuilder.create(), PartPose.offset(-8.5F, 0.0F, -4.0F));

		PartDefinition cube_r9 = Right_Wing.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(163, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-23.5F, -7.0F, 2.4F, -0.0154F, 0.1739F, -0.0886F));

		PartDefinition cube_r10 = Right_Wing.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(163, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-21.5F, 7.0F, 1.6F, -0.053F, 0.1664F, -0.3099F));

		PartDefinition cube_r11 = Right_Wing.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(163, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.5F, 4.0F, -0.4F, -0.053F, 0.1664F, -0.3099F));

		PartDefinition cube_r12 = Right_Wing.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(163, 74).addBox(-12.0F, -7.0F, 0.0F, 24.0F, 14.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.5F, 0.0F, 0.0F, 0.0F, 0.1745F, 0.0F));
		...
		PartDefinition cube_r13 = Right_Shoulder.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(212, 214).addBox(-5.7139F, 3.0763F, -2.5F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition cube_r14 = Right_Shoulder.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(144, 205).addBox(-4.6872F, -8.3566F, -3.0F, 4.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r15 = Broken_Bow.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(104, 147).addBox(-2.0F, -2.0F, -11.0F, 4.0F, 4.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.2474F, 12.1158F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r16 = Broken_Bow.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(58, 146).addBox(-2.0F, -2.0F, -8.0F, 4.0F, 4.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.6601F, -14.2828F, -0.5672F, 0.0F, 0.0F));
		...
		PartDefinition cube_r17 = Broken_Halbard.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(44, 187).addBox(0.0F, -1.5F, -9.0F, 0.0F, 3.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2222F, -63.0556F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r18 = Broken_Halbard.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(146, 66).addBox(1.5F, -0.5F, 0.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r19 = Broken_MaceRight.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(118, 107).addBox(-4.0F, 0.0F, -10.0F, 9.0F, 0.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.4667F, -24.1667F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r20 = Broken_MaceRight.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(118, 107).addBox(-5.0F, 0.0F, -10.0F, 9.0F, 0.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.5333F, -24.1667F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r21 = Sword.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(184, 216).addBox(0.0F, -1.0F, -5.0F, 0.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.4962F, -39.0402F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r22 = Sword.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(122, 170).addBox(0.0F, -1.0F, -12.0F, 0.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.4962F, -20.3402F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r23 = Sword.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(216, 153).addBox(0.0F, -1.0F, -4.0F, 0.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.2031F, -39.9939F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r24 = Sword.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(192, 16).addBox(0.0F, -1.0F, -11.0F, 0.0F, 2.0F, 14.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r25 = Sword.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(216, 144).addBox(0.0F, -1.0F, -5.5F, 0.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.4031F, -7.8939F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r26 = Sword.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(216, 74).addBox(0.0F, -1.0F, -5.5F, 0.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.3969F, -7.8939F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r27 = Sword.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(212, 164).addBox(-0.5F, -1.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -0.0031F, -5.7939F, 0.7418F, 0.0F, 0.0F));
		...
		PartDefinition cube_r28 = Left_Shoulder.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(20, 205).addBox(-2.7043F, -0.3823F, -3.0F, 4.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r29 = Left_Shoulder.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(212, 201).addBox(1.4903F, 1.6486F, -2.5F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3054F));
		...
		PartDefinition cube_r30 = Broken_Mace_Left.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(137, 107).addBox(-5.0F, 0.0F, -10.0F, 9.0F, 0.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.5333F, -24.1667F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r31 = Broken_Mace_Left.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(118, 107).addBox(-4.0F, 0.0F, -10.0F, 9.0F, 0.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.4667F, -24.1667F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r32 = mantle_leg.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(194, 164).addBox(-4.5F, -4.5F, 0.0F, 9.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
		...
		PartDefinition cube_r33 = dwon_mantle.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(216, 56).addBox(-4.5F, -4.5F, 0.0F, 9.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.8F, 0.2F, 0.0436F, 0.0F, 0.0F));
		...
		PartDefinition cube_r34 = LeftLeg.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(188, 201).addBox(-3.0F, -5.0F, -2.5F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6F, 4.0F, 0.0F, 0.0873F, 0.0F, -0.1745F));
		...
		PartDefinition cube_r35 = LeftLeg_Under.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(210, 118).addBox(-3.0F, -2.0F, -2.5F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, 0.5F, 0.5F, 0.48F, 0.0F, 0.0F));
		...
		PartDefinition cube_r36 = RightLeg.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(100, 204).addBox(-3.0F, -5.0F, -1.5F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6F, 4.0F, 0.0F, 0.0873F, 0.0F, 0.1745F));
		...
		PartDefinition cube_r37 = RightLeg_Under.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(210, 131).addBox(-2.0F, -2.0F, -2.5F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.4F, 0.5F, 0.5F, 0.48F, 0.0F, 0.0F));
