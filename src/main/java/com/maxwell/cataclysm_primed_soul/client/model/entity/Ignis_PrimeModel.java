...
public class Ignis_PrimeModel extends HierarchicalModel<Ignis_PrimeEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ignis_primemodel"), "main");
    ...
    public void setupAnim(Ignis_PrimeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.getAnimationState("power_slam"), Ignis_PrimeAnimation.POWER_SLAM, ageInTicks, 1.0F);
        ...
        this.animate(entity.getAnimationState("catch_start"), Ignis_PrimeAnimation.CATCH_START, ageInTicks, 1.0F);
        this.animate(entity.getAnimationState("catch_success"), Ignis_PrimeAnimation.CATCH_SUCCESS, ageInTicks, 1.0F);
        this.animate(entity.getAnimationState("catch_fail"), Ignis_PrimeAnimation.CATCH_FAIL, ageInTicks, 1.0F);
        this.animate(entity.getAnimationState("jab_attack_ex_one"), Ignis_PrimeAnimation.JAB_ATTACK_EX_ONE, ageInTicks, 1.0F);
        this.animate(entity.getAnimationState("overhead_guardbreaker"), Ignis_PrimeAnimation.OVERHEAD_GUARDBREAKER, ageInTicks, 1.0F);
