...
import com.maxwell.cataclysm_primed_soul.client.animation.entity.Ignis_PrimeAnimation;
...
public class Ignis_PrimeModel extends HierarchicalModel<Ignis_PrimeEntity> {
	...
	private final ModelPart Hand_pos;
	...
	public Ignis_PrimeModel(ModelPart root) {
		...
		this.Hand_pos = this.L_Under.getChild("Hand_pos");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hand_pos = L_Under.addOrReplaceChild("Hand_pos", CubeListBuilder.create(), PartPose.offset(0.2381F, 13.5654F, -0.2F));
    ...
    public void setupAnim(Ignis_PrimeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.getAnimationState("guard_counter"), Ignis_PrimeAnimation.GUARD_COUNTER, ageInTicks, 1.0F);
        ...
        this.animate(entity.getAnimationState("dash"), Ignis_PrimeAnimation.DASH, ageInTicks, 1.0F);
        this.animate(entity.getAnimationState("dash_upper"), Ignis_PrimeAnimation.DASH_UPPER, ageInTicks, 1.0F);
