...
public class Maledictus_PrimeAnimation {
	...
	public static final AnimationDefinition ATTACK_JAB_3 = AnimationDefinition.Builder.withLength(3.0F)
		...
		.addAnimation("Sword", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(130.0F, 60.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.7917F, KeyframeAnimations.degreeVec(130.0F, 60.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition ATTACK_SHOCKWAVE_START = AnimationDefinition.Builder.withLength(2.0833F)
		...
		.addAnimation("LeftLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.7083F, KeyframeAnimations.degreeVec(3.483F, -24.7717F, -18.2652F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.1667F, KeyframeAnimations.degreeVec(3.483F, -24.7717F, -18.2652F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("RightLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.7083F, KeyframeAnimations.degreeVec(-0.7879F, 17.4828F, 14.8788F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.1667F, KeyframeAnimations.degreeVec(-0.7879F, 17.4828F, 14.8788F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition ATTACK_SHOCKWAVE_END = AnimationDefinition.Builder.withLength(1.375F)
		...
		.addAnimation("Sword", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.7917F, KeyframeAnimations.degreeVec(169.3584F, -44.4785F, -45.6621F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("UpperBody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.7917F, KeyframeAnimations.degreeVec(18.53F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.2083F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();
	...
	public static final AnimationDefinition ATTACK_GRAB_START = AnimationDefinition.Builder.withLength(1.4583F)
		...
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -0.8F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, -0.8F, 4.09F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, -0.8F, 4.09F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.3333F, KeyframeAnimations.posVec(0.0F, -0.8F, -15.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("Sword", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(175.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("UnderBody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.0417F, KeyframeAnimations.degreeVec(0.0F, -32.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition ATTACK_EX_JAB_2 = AnimationDefinition.Builder.withLength(1.75F)
		.addAnimation("Head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(7.0878F, 12.234F, 4.3934F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("LeftLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-77.5F, -10.0F, -7.5F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.7083F, KeyframeAnimations.degreeVec(-40.0F, -10.0F, -7.5F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("RightLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(17.5F, 10.0F, 5.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(2.488F, -7.488F, 0.5456F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -6.8F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("Right_Shoulder", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-34.8261F, -11.9834F, -69.4281F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("UpperBody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(17.0775F, -25.9531F, 12.7384F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("UnderBody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(23.4245F, -8.4041F, -2.9387F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition ATTACK_EX_JAB_3 = AnimationDefinition.Builder.withLength(2.7083F)
		...
		.addAnimation("UnderBody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.6667F, KeyframeAnimations.degreeVec(-20.8753F, -11.71F, 8.5032F), AnimationChannel.Interpolations.LINEAR),
